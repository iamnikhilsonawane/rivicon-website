...
export default function WhatsAppFloat() {
  ...
  const message = encodeURIComponent(
    "Hello Rivicon Medpack Solutions, I'd like to enquire about your products."
  );
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center whatsapp-pulse shadow-lg hover:scale-110 transition-transform duration-200"
    >
